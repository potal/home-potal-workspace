...
class GiveGiftRQ(object):
    ...
    def Pack(self):
        ...
        packed_data.SerializeLongLong(self.mi64DstUserId);
    ...
    def SendGiveGift(self,dst_user_id,hero_uid,dst_user_name,gift_msg,gift_uid,gift_count):
        ...
        self.mszDstUserName = dst_user_name;
        self.mszMsgUtf8 = gift_msg;
        self.mszGiftUID = gift_uid;
        self.miCount = gift_count;
        self.miTotal = gift_count;
...
class GiveGiftRS(object):
    ...
    def Unpack(self,buff,buff_len):
        ...
        self.mi64DstUserId = unpacked_data.SerializeLongLong(self.mi64DstUserId);
    ...
    def Execute(self,msg_id,buff,buff_len):
        print 'GiveGiftRS Execute';
        self.Unpack(buff, buff_len);
        if self.mi64UserId == self.client.user_id or self.mi64DstUserId == self.client.user_id:
            print 'Give gift success';
            print '{0} give {1} gift(s) {2} to {3}'.format(self.mi64UserId,self.miTotal,self.mszGiftUID,self.mi64DstUserId);
