...
class mikuktv(miku.MikuBase):
    ...
    def UserApplyPublicMic(self,mic_type):#1 is small mic,2 is large mic
        ...
        ret_value = self.WaitForSpeakerInfoList();
        if ret_value[0] == True:
            return 2,self.mi64UserId,ret_value[1],ret_value[2];
        else:
        ...
        while(1):
            ...
            if(result):
                ...
                if speaker_id.mbySpeakerCount > 0:
                    return True,speaker_id.mstrSpeakerInfoList[0].mi64SpeakerUserID,speaker_id.mstrSpeakerInfoList[0].mbyMicIndex;
        return False,0,0;
    ...
    def UserPutPublicMic(self,dst_user_id,mic_type):#1 is small mic,2 is large mic
...
#2,this client is invited player;
    ...
    def UserStopSpeak(self):
        stop_speak_id = PackDefine.UserStopSpeakID();
        stop_speak_id.mi64UserID = self.mi64UserId;
        
        send_buff = stop_speak_id.Pack();
        self.SendPacket(send_buff);
